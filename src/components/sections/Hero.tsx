    ...
    <section id="hero" className="hero">
      <div className="hero-container">
        ...
        <div className="hero-visual">
          <motion.div 
            className="code-window desktop-only"
          ...
          <motion.div 
            className="mobile-card mobile-only"
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 1, delay: 0.6 }}
          >
            <div className="mobile-card-header">
              <div className="mobile-avatar">JP</div>
              <div className="mobile-info">
                <h3>José Juan Pérez</h3>
                <p>Full-Stack & XR Developer</p>
              </div>
            </div>
            <div className="mobile-card-content">
              <div className="mobile-skill-tags">
                ...
                <span className="skill-tag">XR</span>
                <span className="skill-tag">Mobile</span>
              </div>
              <div className="mobile-quote">
                "Creating immersive experiences & mobile solutions"
              </div>
            </div>
          </motion.div>
        </div>
